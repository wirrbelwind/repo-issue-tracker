...
const issueApi = {
	...
	"labels_url": "https://api.github.com/repos/karpathy/llm.c/issues/111/labels{/name}",
	"comments_url": "https://api.github.com/repos/karpathy/llm.c/issues/111/comments",
	...
	"user": {
		...
		"following_url": "https://api.github.com/users/pierrebrunelle/following{/other_user}",
		"gists_url": "https://api.github.com/users/pierrebrunelle/gists{/gist_id}",
		"starred_url": "https://api.github.com/users/pierrebrunelle/starred{/owner}{/repo}",
		"subscriptions_url": "https://api.github.com/users/pierrebrunelle/subscriptions",
		...
		"received_events_url": "https://api.github.com/users/pierrebrunelle/received_events",
		"type": "User",
		"site_admin": false
	},
	"labels": [],
	...
	"timeline_url": "https://api.github.com/repos/karpathy/llm.c/issues/111/timeline",
